...
while True:
    ...
    try:
        ...
        cur.execute("INSERT INTO credit_events (id,email,project_id,task_id,amount,reason) VALUES (%s,%s,%s,%s,%s,%s)", (str(uuid.uuid4()), email, project_id, task_id, -1, f"mock_runtime_{task_type}"))
        conn.commit()
