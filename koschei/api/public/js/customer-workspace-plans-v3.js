...
function render(state){
  const host=document.getElementById('workspaceMissionControl');if(!host)return;
  let section=document.getElementById('workspacePlanStrip');
  if(!section){section=document.createElement('section');section.id='workspacePlanStrip';host.insertAdjacentElement('beforebegin',section);}
  section.className='workspace-plan-strip';section.replaceChildren();host.replaceChildren();
