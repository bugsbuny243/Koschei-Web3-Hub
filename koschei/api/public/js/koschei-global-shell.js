(function(){
  ...
  ready(function(){
    var links=[['/dashboard','Dashboard'],['/security-radar','Radar'],['/token-2022-scanner','Token-2022'],['/transaction-firewall','Firewall'],['/watchlist','Watchlist'],['/webhooks','Webhooks'],['/pricing','Plans']];
    ...
    if(!document.querySelector('.koschei-footer')){var footer=document.createElement('footer');footer.className='koschei-footer';footer.innerHTML='<span>Koschei ARVIS · Solana security infrastructure</span><span><a href="/architecture">Architecture</a> · <a href="/developers">Developers</a> · <a href="/pricing">Plans</a></span>';document.body.appendChild(footer);}
  });
})();
