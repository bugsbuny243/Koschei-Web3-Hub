(function(root,factory){
  ...
  function mapVerdictCard(payload,options={}){
    ...
    const ownerResolvedTopNum=num(ownerResolvedPct), rawTopNum=num(rawTopPct);
    const concentrationIsRaw=ownerResolvedTopNum===null&&rawTopNum!==null;
    const concentrationPct=ownerResolvedTopNum!==null?ownerResolvedPct:rawTopPct;
    const concentrationValue=concentrationPct?`${concentrationPct}%${concentrationIsRaw?' (raw)':''}`:lang.noData;
    const concentrationTriggered=ownerResolvedTopNum!==null&&ownerResolvedTopNum>=50;
    ...
    if(ownerResolvedTopNum!==null&&ownerResolvedTopNum>=50)push('top-owner',lang.rows.holder.replace('{value}',ownerResolvedPct),holderEv,ownerResolvedPct);
