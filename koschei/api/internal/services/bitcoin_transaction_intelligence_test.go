...
func TestAdaptBitcoinTransactionEvidence(t *testing.T) {
	...
	result := networktarget.BitcoinTransactionEvidenceResult{
		...
		TransactionID: txid,
		Version: 2, InputCount: 1, OutputCount: 2, Size: 200, Weight: 800, FeeSats: 1000,
		Confirmed: true, BlockHeight: 900000, BlockHash: strings.Repeat("b",64), BlockTimeUnix: 1700000000,
		TransactionSHA256: strings.Repeat("c",64),
		AnalysisPerformed: true, EvidenceStatus: IntelligenceEvidenceObserved, LiveAvailability: "checked",
	}
