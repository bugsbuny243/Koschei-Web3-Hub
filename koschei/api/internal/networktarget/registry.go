...
var (\n\tevmAddress       = regexp.MustCompile(`^0x[0-9a-fA-F]{40}// Package networktarget binds address syntax to an explicitly selected network.
// Resolution is offline metadata, never evidence of a safe or existing account.
package networktarget
...
)\n\tmoveHex32Address = regexp.MustCompile(`^0x[0-9a-fA-F]{64}// Package networktarget binds address syntax to an explicitly selected network.
// Resolution is offline metadata, never evidence of a safe or existing account.
package networktarget
