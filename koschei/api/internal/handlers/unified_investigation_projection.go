...
func unifiedInvestigationTechnicalProjection(report map[string]any) map[string]any {
	keys := []string{
		...
		"source_context", "structural_memory", "modules", "evidence_arms",
		"evidence", "behavior_signals", "trade_ledger_aggregates",
		"actor_investigation", "graph", "investigation_output_policy", "evidence_policy",
	}
