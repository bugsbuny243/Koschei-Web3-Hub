...
type ModuleStatus = 'ACTIVE' | 'NEXT' | 'PAUSED' | 'FUTURE';

function SectionTitle({ title }: { title: string }) {
  return (
    <View style={styles.sectionHeader}>
      <Text style={styles.sectionKicker}>// PUBLIC ACCESS</Text>
...
const styles = StyleSheet.create({root:{flex:1,backgroundColor:BG,overflow:'hidden'},glowCyan:{position:'absolute',top:-90,left:-110,width:280,height:280,borderRadius:140,backgroundColor:'rgba(0,229,255,0.16)'},glowPurple:{position:'absolute',top:190,right:-160,width:340,height:340,borderRadius:170,backgroundColor:'rgba(157,78,221,0.17)'},glowGreen:{position:'absolute',bottom:120,left:-150,width:320,height:320,borderRadius:160,backgroundColor:'rgba(0,255,157,0.09)'},gridLayer:{position:'absolute',top:0,right:0,bottom:0,left:0,borderWidth:1,borderColor:'rgba(0,229,255,0.04)'},rainLayer:{position:'absolute',top:0,right:0,bottom:0,left:0,opacity:0.3},rainCol:{position:'absolute',top:0},rainText:{fontSize:12,lineHeight:16,fontFamily:'monospace'},scroll:{padding:16,paddingTop:34,paddingBottom:54},topBar:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:14},brandBox:{flexDirection:'row',alignItems:'center',gap:10},brandMark:{color:CYAN,fontSize:28,fontWeight:'900'},brandName:{color:'#fff',fontSize:18,fontWeight:'900',letterSpacing:1.4},brandSub:{color:'#7fa0c0',fontSize:10,fontWeight:'800',letterSpacing:1.2},statusPill:{flexDirection:'row',alignItems:'center',paddingHorizontal:10,paddingVertical:6,borderRadius:999,borderWidth:1,borderColor:'rgba(0,255,157,0.3)',backgroundColor:'rgba(0,255,157,0.08)'},statusDot:{width:8,height:8,borderRadius:4,backgroundColor:GREEN,marginRight:6},statusText:{color:'#d8ffee',fontSize:10,fontWeight:'900',letterSpacing:1},statusRow:{flexDirection:'row',justifyContent:'space-between',marginBottom:10},microText:{color:'#83a0bc',fontSize:10,fontWeight:'800',letterSpacing:1},kicker:{color:CYAN,fontSize:10,fontWeight:'900',letterSpacing:1.2,marginBottom:8},titleSub:{color:'#c7d4e8',fontSize:14,fontWeight:'700',letterSpacing:3,marginBottom:10},sectionHeader:{marginBottom:14,paddingHorizontal:2},sectionKicker:{color:'#6f90af',fontSize:10,fontWeight:'800',letterSpacing:1.3,marginBottom:4},sectionTitle:{color:'#fff',fontSize:20,fontWeight:'900',letterSpacing:1.1},heroPanel:{borderWidth:1,borderColor:'rgba(0,229,255,0.22)',borderRadius:26,backgroundColor:PANEL,padding:18,marginBottom:24},title:{color:'#fff',fontSize:56,fontWeight:'900'},heroText:{color:'#b7c8dd',fontSize:14,lineHeight:22,marginTop:10},coreWrap:{height:260,alignItems:'center',justifyContent:'center'},coreHalo:{position:'absolute',width:190,height:190,borderRadius:95,backgroundColor:'rgba(0,229,255,0.12)'},ring:{position:'absolute',borderWidth:1.4},core:{width:112,height:112,borderRadius:56,borderWidth:1,borderColor:'rgba(0,255,157,0.65)',backgroundColor:'rgba(0,20,26,0.92)',alignItems:'center',justifyContent:'center'},coreTop:{color:CYAN,fontSize:9,fontWeight:'800'},coreNum:{color:'#fff',fontSize:28,fontWeight:'900'},coreBottom:{color:GREEN,fontSize:9,fontWeight:'900'},buttonStack:{marginTop:8},button:{minHeight:54,borderRadius:16,alignItems:'center',justifyContent:'center',marginBottom:12},buttonPrimary:{backgroundColor:GREEN},buttonGhost:{borderWidth:1,borderColor:'rgba(0,229,255,0.42)',backgroundColor:'rgba(0,229,255,0.055)'},buttonText:{fontSize:14,fontWeight:'900',letterSpacing:1.2},moduleGrid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between',marginBottom:24},moduleCard:{width:'48.6%',minHeight:170,borderWidth:1,borderRadius:18,backgroundColor:'rgba(5,12,25,0.82)',padding:14,marginBottom:12},moduleTop:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},moduleIcon:{fontSize:24,fontWeight:'900'},activeBadge:{borderWidth:1,borderColor:'rgba(0,255,157,0.35)',backgroundColor:'rgba(0,255,157,0.1)',borderRadius:999,paddingHorizontal:8,paddingVertical:4},activeText:{color:'#d9ffef',fontSize:8,fontWeight:'900',letterSpacing:1},statusBadge:{borderWidth:1,borderRadius:999,paddingHorizontal:7,paddingVertical:3},badgeActive:{borderColor:'rgba(0,255,157,0.28)',backgroundColor:'rgba(0,255,157,0.08)'},badgeNext:{borderColor:'rgba(255,200,87,0.5)',backgroundColor:'rgba(157,78,221,0.22)'},badgePaused:{borderColor:'rgba(138,160,184,0.4)',backgroundColor:'rgba(138,160,184,0.1)'},badgeFuture:{borderColor:'rgba(255,43,209,0.45)',backgroundColor:'rgba(157,78,221,0.2)'},statusBadgeText:{color:'#d8f2ff',fontSize:7,fontWeight:'900',letterSpacing:0.9},moduleName:{color:'#fff',fontSize:13,fontWeight:'900',marginTop:16},moduleDesc:{color:'#8ea7c2',fontSize:11,lineHeight:16,marginTop:6},moduleNote:{color:CYAN,fontSize:10,fontWeight:'800',marginTop:12,letterSpacing:1},footerPanel:{borderTopWidth:1,borderColor:'rgba(0,229,255,0.12)',paddingTop:18,paddingBottom:18,alignItems:'center'},footerTitle:{color:'#fff',fontSize:12,letterSpacing:2,fontWeight:'900'},footerText:{color:'#52708e',fontSize:10,letterSpacing:1.2,marginTop:6,textAlign:'center'}});
