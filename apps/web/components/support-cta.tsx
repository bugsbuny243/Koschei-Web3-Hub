  ...
  return (
    <section className={`rounded-xl border bg-emerald-50/60 p-5 ${compact ? "" : "space-y-3"}`}>
      ...
      <p className="text-gray-700">
        Koschei is being built as an AI-assisted Web Game Factory and no-custody Web3 Bridge. Small community support helps keep development moving while grant applications are prepared.
      </p>
