...
export async function POST(req: Request) {
  ...
  await pool.query("update supplier_leads set company_name=$2,country=$3,city=$4,is_verified_claimed=$5,likely_manufacturer=$6,likely_trader=$7,manufacturer_score=$8,risk_score=$9,confidence=$10,updated_at=now() where id=$1", [supplierLeadId, analysis.company_name || lead.company_name, analysis.country || lead.country, analysis.city || null, analysis.verified_claim_found, analysis.likely_manufacturer, analysis.likely_trader, analysis.manufacturer_score, analysis.risk_score, analysis.confidence]);
