...
export default function OwnerMediaLibraryPage() {
  ...
  async function load() {
    const res = await fetch(`/api/owner/media/upload-product-image/list?product_slug=${encodeURIComponent(productSlug)}&password=${encodeURIComponent(password)}`);
