...
<input name="supplier_landed_cost" placeholder="supplier_landed_cost" className="input" required/>
...
<select name="markup_type" className="input"><option value="fixed">fixed</option><option value="percent">percent</option></select>
<input name="markup_amount" placeholder="markup_amount" className="input" />
<input name="markup_percent" placeholder="markup_percent" className="input" />
