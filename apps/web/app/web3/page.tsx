...
export default async function Web3Dashboard() {
  try {
    ...
    return <main className="mx-auto max-w-6xl p-6 space-y-4">
      ...
      <div className="flex gap-3 flex-wrap"><Link href="/web3/game-bridge" className="underline">Game Bridge</Link><Link href="/web3/game-bridge/grant" className="underline">Game Bridge Grant</Link><Link href="/web3/invoices" className="underline">PayWatch Invoices</Link><Link href="/web3/testing" className="underline">PayWatch Testing</Link><Link href="/web3/grant" className="underline">PayWatch Grant</Link></div>
    </main>;
  } catch (error) {
    return <main className="mx-auto max-w-6xl p-6 space-y-4">
      <h1 className="text-3xl font-bold">Koschei Web3 Products Dashboard</h1>
