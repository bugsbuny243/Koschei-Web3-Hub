...
export default async function Web3Dashboard() {
  try {
    ...
    return <main className="mx-auto max-w-6xl p-6 space-y-4">
      <h1 className="text-3xl font-bold">Koschei PayWatch for Arbitrum</h1>
      ...
      <div className="flex gap-3"><Link href="/web3/invoices" className="underline">Invoices</Link><Link href="/web3/testing" className="underline">Testing</Link><Link href="/web3/grant" className="underline">Grant</Link></div>
    </main>;
  } catch (error) {
    return <main className="mx-auto max-w-6xl p-6 space-y-4">
      <h1 className="text-3xl font-bold">Koschei PayWatch for Arbitrum</h1>
